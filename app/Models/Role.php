...
class Role extends Model
{
    ...
    protected $fillable = [
        'role_name',
        'is_kintai_list_func_available',
        'is_employee_list_func_available',
        'is_other_func_available',
        'is_data_export_func_available',
        'is_management_func_available',
        'is_system_mgt_func_available',
        'is_accounting_func_available',
        'is_kintai_check_available',
        'is_kintai_delete_available',
        'is_kintai_modify_available',
