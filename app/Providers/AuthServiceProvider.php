...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // 従業員管理機能有効のみ許可
        Gate::define('isEmployeeMgtAvailable', function($user){
            return ($user->role->is_employee_mgt_available == 1);
        });
        // 従業員操作有効のみ許可
        ...
        // 経理管理機能有効のみ許可
        Gate::define('isAccountingFuncAvailable', function($user){
            return ($user->role->is_accounting_func_available == 1);
        });
        // システム管理機能有効のみ許可
