...
class EmployeeMgtController extends Controller
{
    ...
    public function detail(Request $request)
    {
        ...
        // 勤怠表に使用する情報を取得
        $kintais = $KintaiReportDownloadService->getDownloadKintai(Auth::user()->base->base_name, $month_date, Employee::getSpecify($request->employee_id)->get(), $start_end_of_month['start'], $start_end_of_month['end']);
        // 追加休憩取得時間が有効か判定
