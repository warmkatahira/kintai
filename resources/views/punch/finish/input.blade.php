...
<x-app-layout>
    ...
    <div class="my-5">
        ...
        <!-- 休憩取得時間変更モーダル -->
        <x-punch.rest-time-change-modal :employeeFullName="$kintai->employee->employee_last_name.$kintai->employee->employee_first_name" :defaultRestTime="$default_rest_time" :restTimes="$rest_times" />
