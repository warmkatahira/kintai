    ...
    <div class="my-5">
        ...
        <div class="bg-white border border-gray-200 px-10 py-5 whitespace-nowrap">
            <form method="POST" action="{{ route('base_create.create') }}" class="m-0" id="base_create_form">
                ...
                <x-base-mgt.rest-related-select-mode label="休憩関連選択モード" id="rest_related_select_mode" :restRelatedSelectMode="$rest_related_select_mode" :db="null" required="1" tippy="0" />
