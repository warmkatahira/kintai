            ...
            <div class="grid grid-cols-12">
                ...
                <div class="col-start-1 col-span-12 my-10">
                    ...
                    <div class="col-span-12 grid grid-cols-12 mt-5">
                        <p class="col-span-12 text-4xl text-red-500 py-2">雇用契約上の基本休憩時間よりも短い休憩の取得の場合には、所長の許可が必要になります。許可を得ていますか？</p>
                        <p id="law_violated_warning" class="col-span-12 text-4xl text-red-500 bg-yellow-200 text-center py-2">休憩時間が法令に違反しています</p>
                    </div>
                </div>
