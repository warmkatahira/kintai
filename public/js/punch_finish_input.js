...
var modal = document.getElementById('working_time_input_modal');
var input_customer_id = document.getElementById('input_customer_id');
var input_customer_name = document.getElementById('input_customer_name');
var input_working_time = document.getElementById('input_working_time');
var input_working_time_info = document.getElementById('input_working_time_info');
var input_time_left = document.getElementById('input_time_left');
var input_time_left_modal = document.getElementById('input_time_left_modal');
...
$("#working_time_input_enter").on("click", function () {
  try {
    ...
    // 表示させる要素を作成して表示
    var working_time_input = document.createElement('button');
    ...
    // 送信する要素を作成して表示
    var working_time_hidden = document.createElement('input');
...
$(document).on("click", ".working_time_info_delete", function () {
  var delete_target_1 = document.getElementById(this.id);
  var delete_target_2 = document.getElementById(this.id + '_hidden');
  // 残り入力時間を更新
...
function rest_time_update() {
  ...
  for (var i = 0; i < add_rest_times.length; i++) {
    ...
    if (add_rest_times[i].checked) {
      _element.classList.add('bg-blue-200');
      // 選択している追加休憩時間を取得
  ...
  // 休憩時間を変更 
  rest_time.value = Number(org_rest_time.value) - Number(select_no_rest_time.value) + Number(select_add_rest_time_value);
  // 勤務時間を変更
  working_time.value = ((Number(org_working_time.value) + Number(select_no_rest_time.value) - Number(select_add_rest_time_value)) / 60).toFixed(2);
  // 残り入力時間を変更
...
$('#punch_finish_enter').on("click", function () {
  ...
  try {
    ...
    if ($('[name="no_rest_time"]:checked').length == 0) {
