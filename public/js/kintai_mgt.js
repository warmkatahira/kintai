...
/*!***********************************************!*\
  ...
  \***********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _checkbox__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../checkbox */ "./resources/js/checkbox.js");
...
$('#base_check_enter').on("click", function () {
  try {
    // チェックボックス要素関連の情報を取得
    var _get_checkbox3 = (0,_checkbox__WEBPACK_IMPORTED_MODULE_0__["default"])(),
    ...
    // 処理を実行するか確認
    var result = window.confirm(count + "件の勤怠の拠点確認を実行しますか？");
